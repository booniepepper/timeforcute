...
<p><?php _e('Enter your password to view requests.'); ?></p>
<?php return; endif; ?>

<?php if ( comments_open() ) : ?>
<h3 id="comments"><?php comments_number(__('No Requests'), __('1 Request'), __('% Requests')); ?> 

	<a href="#postcomment" title="<?php _e("Make a request!"); ?>"></a>
<?php endif; ?>
</h3>
...
<?php if ( comments_open() ) : ?>
	<p><?php _e('No requests yet, hop to it!'); ?></p>
<?php endif; ?>	
...
<?php endif; ?>
<?php if ( comments_open() ) : ?>
<h3 id="postcomment"><?php _e('Make a request'); ?></h3>
